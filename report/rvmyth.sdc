...
# Created by write_sdc on Mon Oct 6 18:37:36 2025
...
set_input_delay -clock CLK  -max 4  [get_ports CLK]
...
set_output_delay -clock CLK  0.5  [get_ports {OUT[9]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[8]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[7]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[6]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[5]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[4]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[3]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[2]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[1]}]
set_output_delay -clock CLK  0.5  [get_ports {OUT[0]}]
